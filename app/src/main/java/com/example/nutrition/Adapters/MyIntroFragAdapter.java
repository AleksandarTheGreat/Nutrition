...
public class MyIntroFragAdapter extends FragmentStateAdapter {
    ...
    private void setUpFragmentList() {
        ...
        fragmentList.add(new FragmentMythReality(appCompatActivity, new MRModel("Why are you active and fit when you are still eating sugary foods after the workout, that doesn't make any sense, they aren't healthy.", "Actually, of the smartest things to do after a workout is to replenish your energy as fast as possible, so the sugary foods can be absorbed a lot quicker than fruit for example and help us refuel quicker.")));
