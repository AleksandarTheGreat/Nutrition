...
public class MyIntroFragAdapter extends FragmentStateAdapter {
    ...
    private void setUpSearchExampleFragments(){
        ...
        fragmentList.add(new FragmentSearchExample(isNightModeActive, new SEModel("Valid Searches", "All of these are examples of how we should search for food items", new String[]{"2 tablespoons of olive oil", "3 slices of bread", "300 grams cooked potatoes", "3 bowls of spaghetti", "100 grams peanut butter", "5 grams of sugar", "2 liters orange juice", "200 grams chicken"}, R.drawable.ic_correct)));
        fragmentList.add(new FragmentSearchExample(isNightModeActive, new SEModel("Invalid Searches", "All of these are examples of how we should NOT search for food items, even though we might still get absurd results", new String[]{"1 galaxy of salt", "500 liters of cake", "12345", "pasta and cheese and chicken and beef and broccoli and carrots and spinach and tomatoes and potatoes", "randomfoodthatisnotreal ", "sdfghjk", "1.5x chicken"}, R.drawable.ic_wrong)));
    }
