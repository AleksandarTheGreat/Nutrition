...
public class MyIntroFragAdapter extends FragmentStateAdapter {
    ...
    private void setUpSearchExampleFragments(){
        ...
        fragmentList.add(new FragmentSearchExample(isNightModeActive, new SEModel("Solid Measurements", "Acceptable units for solid form.", new String[]{"Grams (g)", "Kilograms (kg)", "Milligrams (mg)", "Ounces (oz)", "Pounds (lb)"}, R.drawable.icon_solid, R.drawable.icon_solid)));
        fragmentList.add(new FragmentSearchExample(isNightModeActive, new SEModel("Liquid Measurements", "Acceptable units for liquid form", new String[]{"Liters (l)", "Milliliters (ml)", "Teaspoons (tsp)", "Tablespoons (tbsp)", "Cups", "Fluid ounces (fl oz)", "Pints (pt)", "Quarts (qt)", "Gallons (gal)"}, R.drawable.ic_liquid, R.drawable.ic_liquid)));
        fragmentList.add(new FragmentSearchExample(isNightModeActive, new SEModel("Item Measurements", "Everyday items used for cooking", new String[]{"Slice", "Bowl", "Piece", "Can", "Stick", "Fillet", "Cube", "Bag", "Jar"}, R.drawable.ic_search, R.drawable.ic_search)));
    }
