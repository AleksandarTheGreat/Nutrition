...
// Proteins
        productList.add(Product.createProduct("Chicken Breast", "Protein", 31, 0, 165, 0));
        productList.add(Product.createProduct("Eggs", "Protein", 13, 1.1, 155, 1.1));
        productList.add(Product.createProduct("Almonds", "Protein", 21, 22, 576, 4.4));
        productList.add(Product.createProduct("Beef", "Protein", 26, 0, 250, 0));
        productList.add(Product.createProduct("Lentils", "Protein", 9, 20, 116, 1.8));
        productList.add(Product.createProduct("Tofu", "Protein", 8, 2, 70, 0.5));
        productList.add(Product.createProduct("Chickpeas", "Protein", 8.9, 27.4, 164, 4.8));
        productList.add(Product.createProduct("Turkey Breast", "Protein", 29, 0, 135, 0));
        productList.add(Product.createProduct("Salmon", "Protein", 25, 0, 206, 0));
        productList.add(Product.createProduct("Peanuts", "Protein", 25.8, 16.1, 567, 4.7));
        productList.add(Product.createProduct("Tuna", "Protein", 24, 0, 144, 0));
        productList.add(Product.createProduct("Shrimp", "Protein", 24, 0.2, 99, 0.2));
        productList.add(Product.createProduct("Pork Loin", "Protein", 27, 0, 242, 0));
        productList.add(Product.createProduct("Cod", "Protein", 20, 0, 82, 0));
        productList.add(Product.createProduct("Cottage Cheese", "Protein", 11, 3.4, 98, 2.7));
        productList.add(Product.createProduct("Mozzarella Cheese", "Protein", 22, 2.2, 280, 1));
        productList.add(Product.createProduct("Edamame", "Protein", 11, 9, 122, 2.2));
        productList.add(Product.createProduct("Tempeh", "Protein", 19, 9, 192, 0.5));
        productList.add(Product.createProduct("Pumpkin Seeds", "Protein", 19, 53, 446, 1.4));
        productList.add(Product.createProduct("Sunflower Seeds", "Protein", 21, 20, 584, 2.6));
        productList.add(Product.createProduct("Quinoa", "Protein", 4.1, 21, 120, 0.9));
        productList.add(Product.createProduct("Black Beans", "Protein", 9, 23, 132, 0.3));
        productList.add(Product.createProduct("Peas", "Protein", 5.4, 14, 81, 5.7));
        productList.add(Product.createProduct("Flax Seeds", "Protein", 18, 29, 534, 1.6));
        productList.add(Product.createProduct("Hemp Seeds", "Protein", 31.6, 8.7, 553, 1.5));
        productList.add(Product.createProduct("Chia Seeds", "Protein", 16.5, 42, 486, 0));
        productList.add(Product.createProduct("Walnuts", "Protein", 15, 14, 654, 2.6));
        productList.add(Product.createProduct("Cashews", "Protein", 18, 30, 553, 5.9));
        productList.add(Product.createProduct("Brazil Nuts", "Protein", 14, 12, 656, 2.3));
